...
class Oiseaux
{
    public static $oiseaux = [
        ...
        'lagopedeAlpin' => [
            'nom' => 'Lagopède alpin',
            'lien' => 'galliformes |phasianides',
            'commentaire' => "De brun en été il devient grisâtre avec le dessous blanc en automne.
            En hiver il est totalement blanc.
            Au printemps-été le mâle a une livrée nuptiale où domine le gris-brun, la femelle est d'un rouge-brun, puis se recouvre de brun en fin d'été.",
            'images' => [
                0 => [
                    'commentaire' => 'Mâle à gauche, femelle à droite'
                ],
                1 => [
                    'commentaire' => "Plumage d'été"
                ],
                2 => [
                    'commentaire' => "Plumage d'hiver"
                ]
            ]
        ],
        'grandTetras' => [
        ...
        'gangaCata' => [
            'nom' => 'Ganga cata',
            'lien' => 'pterocliformes|pteroclides',
            'commentaire' => "",
            'images' => []
        ],
        'grebeCastagneux' => [
        ...
        'flamantRose' => [
            'nom' => 'Flamant rose',
            'lien' => 'phoenicopteriformes|phoenicopterides',
            'commentaire' => "",
            'images' => []
        ],
        'engouleventDEurope' => [
            'nom' => "Engoulevent d'Europe",
            'lien' => 'caprimulgiformes|caprimulgides',
            'commentaire' => "",
            'images' => []
        ],
        'martinetNoir' => [
            'nom' => 'Martinet noir',
            'lien' => 'apodiformes|apodides',
            'commentaire' => "",
            'images' => []
        ],
        ...
        'puffinDesBaleares' => [
            ...
            'lien' => 'procellariiformes|procellariides',
            'commentaire' => "",
            'images' => []
        ],
        'fulmarBoreal' => [
        ...
        'oceaniteTempete' => [
            ...
            'lien' => 'procellariiformes|hydrobatides',
            'commentaire' => "",
            'images' => []
        ],
        'cigogneBlanche' => [
            'nom' => 'Cigogne blanche',
            'lien' => 'ciconiiformes|ciconiides',
            'commentaire' => "",
            'images' => []
        ],
        'cigogneNoire' => [
        ...
        'spatuleBlanche' => [
            'nom' => 'Spatule blanche',
            'lien' => 'threskiornithides|ardeides',
            'commentaire' => "",
            'images' => []
        ],
        'ibisSacre' => [
        ...
        'fouDeBassan' => [
            'nom' => 'Fou de Bassan',
            'lien' => 'suliformes|sulides',
            'commentaire' => "",
            'images' => []
        ],
        'outardeCanepetiere' => [
            'nom' => 'Outarde canepetière',
            'lien' => 'otidiformes|otidides',
            'commentaire' => "",
            'images' => []
        ],
        'outardeBarbue' => [
        ...
        'grueCendree' => [
            'nom' => 'Grue cendrée',
            'lien' => 'gruiformes|gruides',
            'commentaire' => "",
            'images' => []
        ],
        'foulqueMacroule' => [
            'nom' => 'Foulque macroule',
            'lien' => 'gruiformes|rallides',
            'commentaire' => "",
            'images' => []
        ],
        'gallinulePouleDEau' => [
            'nom' => "Gallinule poule d'eau",
            'lien' => 'anseriformes|rallides',
            'commentaire' => "",
            'images' => []
        ],
        'coucouGris' => [
            'nom' => 'Coucou gris',
            'lien' => 'cuculiformes|cuculides',
            'commentaire' => "",
            'images' => []
        ],
        'avocetteElegante' => [
            'nom' => 'Avocette élégante',
            'lien' => 'charadriiformes|recurvirostrides',
            'commentaire' => "",
            'images' => []
        ],
        'echasseBlanche' => [
        ...
        'huitrierPie' => [
            'nom' => 'Huîtrier pie',
            'lien' => 'charadriiformes|haematopodides',
            'commentaire' => "",
            'images' => []
        ],
        'oedicnemeCriard' => [
            'nom' => 'Oedicnème criard',
            'lien' => 'charadriiformes|burhinides',
            'commentaire' => "",
            'images' => []
        ],
        'bargeAQueueNoire' => [
        ...
        'balbuzardPecheur' => [
            ...
            'lien' => 'accipitriformes|pandionides',
            'commentaire' => "",
            'images' => []
        ],
        'chevecheDAthena' => [
        ...
        'effraieDesClochers' => [
            ...
            'lien' => 'strigiformes|tytonides',
            'commentaire' => "",
            'images' => []
        ],
        'guepierDEurope' => [
            'nom' => "Guêpier d'Europe",
            'lien' => 'coraciiformes|meropides',
            'commentaire' => "",
            'images' => []
        ],
        'rollierDEurope' => [
            'nom' => "Rollier d'Europe",
            'lien' => 'coraciiformes|coraciides',
            'commentaire' => "",
            'images' => []
        ],
        'martinPecheurDEurope' => [
            'nom' => "Martin-pêcheur d'Europe",
            'lien' => 'coraciiformes|alcedinides',
            'commentaire' => "",
            'images' => []
        ],
        'huppeFasciee' => [
            'nom' => 'Huppe fasciée',
            'lien' => 'bucerotiformes|upupides',
            'commentaire' => "",
            'images' => []
        ],
        'picNoir' => [
        ...
        'alouetteDesChamps' => [
            ...
            'lien' => 'passeriformes|alaudides',
            'commentaire' => "",
            'images' => []
        ],
        'bergeronnetteGrise' => [
            'nom' => 'Bergeronnette grise',
            'lien' => 'passeriformes|motacillides',
            'commentaire' => "",
            'images' => []
        ],
        'manchotDuCap' => [
            'nom' => 'Manchot du Cap',
            'lien' => 'sphenisciformes|spheniscides',
            'commentaire' => "",
            'images' => []
        ],
        'manchotEmpereur' => [
